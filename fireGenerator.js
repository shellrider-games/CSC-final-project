...
class FireGenerator extends ParticleManager{
    ...
    update(delta){
        ...
        if(this.nextParticle <= 0){
            this.addParticle(new Particle(this.position.x,this.position.y,4,[255,randomNumberBetween(0,255),0],0.25,this.direction.rotate(randomNumberBetween(-30,30)*0.017453),200));
